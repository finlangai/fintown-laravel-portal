...
const SearchFinancial: React.FC<any> = ({ searchTerm, setSearchTerm, setquy, setnam, reset, SetResetOption }) => {
   const [quy, setLocalQuy] = useState<string | undefined>(undefined);
   const [nam, setLocalNam] = useState<string | undefined>(undefined);
   ...
   }, [reset, SetResetOption, setquy, setnam]);
      ...
      <>
         <div className="flex-1 relative flex items-center mx-2">
            ...
            <input
               ...
               className="pl-10 pr-4 py-2 border border-gray-300 rounded-3xl bg-transparent placeholder-gray-500 w-full text-sm text-white"
            />
         </div>
         <div className="flex-1 flex items-center justify-center mx-2 rounded">
            <Select onValueChange={handleSelectChangeQuy} value={quy}>
         ...
         <div className="flex-1 flex items-center justify-center mx-2 rounded">
            <Select onValueChange={handleSelectChangeNam} value={nam}>
               <SelectTrigger className="w-[180px] text-text-Content">
