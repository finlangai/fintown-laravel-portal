...
export default function CompanyEdit() {
  ...
  return (
    <AuthenticatedLayout
      ...
      //             <li className="ml-2 p-2 text-white cursor-pointer" onClick={() => setIsExpanded(true)} >
      ...
      //                 </div>
      //             </li>
      //             <li className="ml-2 p-2 text-white cursor-pointer">
      //                 <div className="flex items-center">
      //                     {isExpanded ? (
      //                         <span className="ml-4 text-xs whitespace-nowrap">{menuItem[0]}</span>
      //                     ) : (
      ...
      //                 <div className="flex items-center">
      //                     {isExpanded ? (
      //                         <span className="ml-4 text-xs whitespace-nowrap">{menuItem[1]}</span>
      //                     ) : (
      ...
      //                 <div className="flex items-center">
      //                     {isExpanded ? (
      //                         <span className="ml-4 text-xs whitespace-nowrap">{menuItem[2]}</span>
      //                     ) : (
      ...
      //                 <div className="flex items-center">
      //                     {isExpanded ? (
      //                         <span className="ml-4 text-xs whitespace-nowrap">{menuItem[3]}</span>
      //                     ) : (
      ...
      //                 <div className="flex items-center">
      //                     {isExpanded ? (
      //                         <p className="items-center font-semibold text-2xl text-text-Content whitespace-nowrap">Công ty</p>
      //                     ):(
      ...
      //                 <div className="flex items-center">
      //                     {isExpanded ? (
      //                         <a href="/company"><span className="ml-4 text-xs whitespace-nowrap">{menuFiintown[0]}</span></a>
      //                     ) : (
      //                         <a href="/company">
      ...
      //                 <div className="flex items-center">
      //                     {isExpanded ? (
      //                         <a href="/financial"><span className="ml-4 text-xs whitespace-nowrap">{menuFiintown[1]}</span></a>
      //                     ) : (
      //                         <a href="/financial">
      ...
      //                 <div className="flex items-center">
      //                     {isExpanded ? (
      //                         <span className="ml-4 text-xs whitespace-nowrap">{menuFiintown[2]}</span>
      //                     ) : (
      //                         <svg xmlns="http://www.w3.org/2000/svg" width={20} height={20} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className="lucide-trending-up-down lucide" > <path d="M14.828 14.828 21 21" /> <path d="M21 16v5h-5" /> <path d="m21 3-9 9-4-4-6 6" /> <path d="M21 8V3h-5" /> </svg>
      ...
      //                 <div className="flex items-center">
      //                     {isExpanded ? (
      //                         <span className="ml-4 text-xs whitespace-nowrap">{menuFiintown[3]}</span>
      //                     ) : (
