...
const badgeVariants = cva(
  "inline-flex items-center border-neutral-200 dark:border-neutral-800 px-2.5 py-0.5 border rounded-md focus:ring-2 focus:ring-neutral-950 dark:focus:ring-neutral-300 focus:ring-offset-2 font-semibold text-xs transition-colors focus:outline-none",
  {
    variants: {
      variant: {
        default:
