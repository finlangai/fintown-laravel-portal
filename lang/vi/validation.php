...
return [
    ...
    "accepted_if" =>
        "Trường :attribute phải được chấp nhận khi :other là :value.",
    "active_url" => "Trường :attribute không phải là một URL hợp lệ.",
    "after" => "Trường :attribute phải là một ngày sau ngày :date.",
    "after_or_equal" =>
        "Trường :attribute phải là thời gian bắt đầu sau hoặc đúng bằng :date.",
    "alpha" => "Trường :attribute chỉ có thể chứa các chữ cái.",
    "alpha_dash" =>
        "Trường :attribute chỉ có thể chứa chữ cái, số và dấu gạch ngang.",
    "alpha_num" => "Trường :attribute chỉ có thể chứa chữ cái và số.",
    "array" => "Trường :attribute phải là dạng mảng.",
    "attached" => "Trường :attribute đã được đính kèm.",
    "before" => "Trường :attribute phải là một ngày trước ngày :date.",
    "before_or_equal" =>
        "Trường :attribute phải là thời gian bắt đầu trước hoặc đúng bằng :date.",
    "between" => [
        "array" => "Trường :attribute phải có từ :min - :max phần tử.",
        "file" =>
            "Dung lượng tập tin trong trường :attribute phải từ :min - :max kB.",
    ...
    "ends_with" =>
        "Trường :attribute phải kết thúc bằng một trong những giá trị sau: :values",
    ...
    "gte" => [
        ...
        "file" =>
            "Dung lượng trường :attribute phải lớn hơn hoặc bằng :value kilobytes.",
        "numeric" => "Giá trị trường :attribute phải lớn hơn hoặc bằng :value.",
        "string" =>
            "Độ dài trường :attribute phải lớn hơn hoặc bằng :value kí tự.",
    ],
    ...
    "lte" => [
        ...
        "file" =>
            "Dung lượng trường :attribute phải nhỏ hơn hoặc bằng :value kilobytes.",
        "numeric" => "Giá trị trường :attribute phải nhỏ hơn hoặc bằng :value.",
        "string" =>
            "Độ dài trường :attribute phải nhỏ hơn hoặc bằng :value kí tự.",
    ],
    "max" => [
        "array" => "Trường :attribute không được lớn hơn :max phần tử.",
        "file" =>
            "Dung lượng tập tin trong trường :attribute không được lớn hơn :max kB.",
    ...
    "mimetypes" =>
        "Trường :attribute phải là một tập tin có định dạng: :values.",
    "min" => [
        "array" => "Trường :attribute phải có tối thiểu :min phần tử.",
        "file" =>
            "Dung lượng tập tin trong trường :attribute phải tối thiểu :min kB.",
    ...
    "prohibited_unless" =>
        "Trường :attribute bị cấm trừ khi :other là một trong :values.",
    ...
    "required_if" =>
        "Trường :attribute không được bỏ trống khi trường :other là :value.",
    "required_unless" =>
        "Trường :attribute không được bỏ trống trừ khi :other là :values.",
    "required_with" =>
        "Trường :attribute không được bỏ trống khi một trong :values có giá trị.",
    "required_with_all" =>
        "Trường :attribute không được bỏ trống khi tất cả :values có giá trị.",
    "required_without" =>
        "Trường :attribute không được bỏ trống khi một trong :values không có giá trị.",
    "required_without_all" =>
        "Trường :attribute không được bỏ trống khi tất cả :values không có giá trị.",
    "same" => "Trường :attribute và :other phải giống nhau.",
    "size" => [
        "array" => "Trường :attribute phải chứa :size phần tử.",
        "file" =>
            "Dung lượng tập tin trong trường :attribute phải bằng :size kB.",
        "numeric" => "Trường :attribute phải bằng :size.",
        "string" => "Trường :attribute phải chứa :size kí tự.",
    ],
    "starts_with" =>
        "Trường :attribute phải được bắt đầu bằng một trong những giá trị sau: :values",
